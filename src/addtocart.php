...
if (isset($_POST['sel_item_id'])) {
    ...
    $safe_sel_item_id = mysqli_real_escape_string(
        $mysqli,
        $_POST['sel_item_id']
    );
    $safe_sel_item_qty = mysqli_real_escape_string(
        $mysqli,
        $_POST['sel_item_qty']
    );
    $safe_sel_item_size = mysqli_real_escape_string(
        $mysqli,
        $_POST['sel_item_size']
    );
    $safe_sel_item_color = mysqli_real_escape_string(
        $mysqli,
